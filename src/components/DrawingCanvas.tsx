    ...
    <div className="flex flex-col items-center w-full max-w-4xl mx-auto bg-white rounded-xl shadow-md p-6">
      ...
      <div className="flex flex-col w-full gap-4 mb-4">
        ...
        <div className="bg-white border rounded-md overflow-hidden relative">
          <canvas
            ...
            style={{
              cursor: tool === 'text' ? 'text' : tool === 'eraser' ? 'eraser' : 'crosshair'
            }}
          />
          
          {/* Controls overlay for shapes and text */}
          {(tool === 'text' || tool === 'rectangle' || tool === 'circle') && (
            <div className="absolute top-2 right-2 bg-white/80 backdrop-blur-sm p-2 rounded-md border shadow-sm flex gap-2">
        ...
        {(tool === 'pen' || tool === 'eraser') && (
          <div className="flex items-center gap-2">
            <Label className="whitespace-nowrap text-xs">Line Width</Label>
            <Slider
              value={width}
              onValueChange={(value) => {
                setWidth(value);
                if (contextRef.current) {
                  contextRef.current.lineWidth = value[0];
                }
              }}
              max={30}
              step={1}
            ...
            />
            <span className="text-xs w-6">{width[0]}px</span>
          </div>
        )}
        ...
        {tool === 'text' && (
          <div className="flex items-center gap-2">
            <Label className="whitespace-nowrap text-xs">Text Size</Label>
            <Slider
              value={textSize}
              ...
              className="w-full max-w-xs"
            />
            <span className="text-xs w-6">{textSize[0]}px</span>
          </div>
        )}
        ...
        {tool === 'text' && (
          <div className="flex items-center gap-2">
            <Label className="whitespace-nowrap text-xs">Font</Label>
            <Select 
              value={textFont} 
      ...
      <Dialog open={textDialogOpen} onOpenChange={setTextDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            <Button variant="secondary" onClick={() => setTextDialogOpen(false)}>
              Cancel
            </Button>
