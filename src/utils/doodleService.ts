...
export async function generateSampleDoodles(): Promise<Doodle[]> {
  ...
  // Sample cartoon-style doodle images - all data:image base64 format to ensure cartoon-style look
  const sampleImages = [
