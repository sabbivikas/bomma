...
export async function generateSampleDoodles(): Promise<Doodle[]> {
  ...
  if (error) {
    console.error('Error creating sample doodles:', error);
    return [];
  }
